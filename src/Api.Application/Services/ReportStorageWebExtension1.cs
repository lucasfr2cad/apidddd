...
namespace Api.Application.Services
{
    public class ReportStorageWebExtension1 : DevExpress.XtraReports.Web.Extensions.ReportStorageWebExtension {
        ...
        public override byte[] GetData(string url) {
            ...
            var report = findLayout(idReport);
            if(report == null)
            {
        ...
        public  byte[] findLayout(int idReport)
        {
             var Layout1 =  LayoutService.Get(idReport);
             byte[] teste = StringParaByteArray(Layout1.Result.ds_conteudo);
             return teste;
        }
        ...
        public  override void SetData(XtraReport report, string url) {
           ...
           MemoryStream output = new MemoryStream();
            ...
            Layout.ds_conteudo =  StringParaByteArray(output.ToArray());
        ...
        public static String StringParaByteArray(byte[] str){
