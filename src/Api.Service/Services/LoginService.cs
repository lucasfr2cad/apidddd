        ...
        public async Task<LoginResponse> FindByLogin(LoginDto user)
        {
            ...
            if (user != null && !string.IsNullOrWhiteSpace(user.Email))
            {
...

                {
                    ...
                    if (baseUser == null)
                    {
                        failResponse.message = _localizer["userNotFound"].Value;
                    }
                    else
                    {
                        failResponse.message = _localizer["passNotFound"].Value;
                    }
                }
                else
                {
                    ...
                    {
                        failResponse.message = _localizer["sessionLimit"].Value;
                    }
                    else
                    {
            ...
            {
                failResponse.message = _localizer["authenticateFailed"].Value;
            }
            return failResponse;
        }
